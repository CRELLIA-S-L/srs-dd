...
| Precious file | A file that may already be the project's own — CI config, agent guides, `.gitattributes`, the hook, the standard — refreshed only with `--force` and only when it carries the SRS-DD marker |
