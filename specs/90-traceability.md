...
| **FR-VIEW-250** What the specification is divided into | `deferred` | T | — | — |
...
| **IF-SPEC-010** | FR-CHK-110 (depends_on), FR-CHK-170 (derives_from), FR-CHK-180 (derives_from), FR-SKILL-200 (depends_on), FR-VIEW-020 (depends_on), FR-VIEW-220 (depends_on), FR-VIEW-250 (depends_on), IF-VIEW-010 (depends_on) |
