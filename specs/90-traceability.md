...
| **FR-SKILL-120** The authoring procedure judges what no checker reaches | `implemented` | I | `.claude/skills/srs-new/SKILL.md` | — |
...
- **FR-SKILL-120** (`implemented`, method `I`) — The authoring procedure judges what no checker reaches
