...
| **FR-SKILL-080** The baseline procedure travels with the project | `partial` | T | `.claude/skills/srs-baseline/SKILL.md`<br>`tools/srs_init.py` | `tests/installer-smoke.sh` |
| **FR-SKILL-090** Authoring a requirement is not implementing it | `deferred` | I | — | — |
| **FR-SKILL-100** The checks a change calls for are named, not guessed | `deferred` | I | — | — |
| **FR-SKILL-110** The specification can be read as a page on request | `deferred` | I | — | — |
| **FR-SKILL-120** The authoring procedure judges what no checker reaches | `deferred` | I | — | — |
