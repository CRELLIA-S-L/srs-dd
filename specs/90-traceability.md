...
| **FR-VIEW-120** The baseline row is written by the tooling | `implemented` | T | `tools/srs_view.py` | `tests/release-smoke.sh` |
...
| **FR-VIEW-120** | FR-CI-070 (depends_on) |
...
No requirement references them: 0 of 6.
