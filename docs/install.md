...
- `skeleton/specs/` → `specs/` (the starter files), plus `specs/README.md` and `specs/adr/template.md` from this repository — the standard itself and the decision template, each kept in one copy;
