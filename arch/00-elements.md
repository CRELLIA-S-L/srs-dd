...
requirements: [CON-SPEC-010, CON-SPEC-030, FR-CHK-010, FR-CHK-020, FR-CHK-030, FR-CHK-040, FR-CHK-050, FR-CHK-055, FR-CHK-060, FR-CHK-070, FR-CHK-075, FR-CHK-080, FR-CHK-090, FR-CHK-100, FR-CHK-110, FR-CHK-120, FR-CHK-130, FR-CHK-140, FR-CHK-150, FR-CHK-160, FR-CHK-170, FR-CHK-180, FR-CHK-190, FR-CHK-200, FR-CHK-210, FR-CHK-220, FR-CHK-230, FR-CHK-240, FR-CHK-250, FR-CHK-260, IF-CI-020, IF-SPEC-010, IF-SPEC-020, INV-SPEC-010, INV-SPEC-020, INV-SPEC-050, INV-SPEC-080, INV-SPEC-090, NFR-CHK-010, NFR-SPEC-010]
depends_on: []
```
...
requirements: [CON-SPEC-020, CON-SPEC-030, FR-ARCH-120, FR-ARCH-130, FR-ARCH-140, FR-ARCH-150, FR-CHK-210, FR-CI-050, FR-GND-280, FR-GND-290, FR-GND-300, FR-GND-320, FR-GND-480, FR-INIT-010, FR-INIT-020, FR-INIT-030, FR-INIT-040, FR-INIT-050, FR-INIT-060, FR-INIT-070, FR-INIT-080, FR-INIT-090, FR-INIT-100, FR-INIT-110, FR-INIT-120, FR-INIT-130, FR-INIT-140, FR-INIT-150, FR-INIT-160, FR-INIT-170, FR-INIT-180, FR-INIT-190, FR-INIT-200, FR-INIT-210, FR-INIT-220, FR-INIT-230, FR-INIT-240, FR-SKILL-060, FR-SKILL-070, FR-SKILL-080, FR-SKILL-100, FR-SKILL-110, IF-CI-010, INV-SPEC-080, NFR-SPEC-010]
depends_on: [E-010]
```
...
```yaml
status: built
carries: [.claude/skills, AGENTS.md, CLAUDE.md, tools/srs_cite_eval.py, tools/srs_proc_eval.py, tests/eval]
requirements: [FR-ARCH-150, FR-ARCH-160, FR-ARCH-240, FR-GND-320, FR-GND-330, FR-GND-340, FR-GND-350, FR-GND-360, FR-GND-380, FR-GND-440, FR-GND-500, FR-GND-530, FR-SKILL-010, FR-SKILL-020, FR-SKILL-030, FR-SKILL-040, FR-SKILL-050, FR-SKILL-060, FR-SKILL-070, FR-SKILL-080, FR-SKILL-090, FR-SKILL-100, FR-SKILL-110, FR-SKILL-120, FR-SKILL-130, FR-SKILL-140, FR-SKILL-150, FR-SKILL-160, FR-SKILL-170, FR-SKILL-180, FR-SKILL-190, FR-SKILL-200, FR-SKILL-210, FR-SKILL-220, FR-SKILL-230, FR-SKILL-240, FR-SKILL-250, FR-SKILL-260, FR-SKILL-270, FR-SKILL-280, FR-SKILL-290, FR-SKILL-300, FR-SKILL-310, FR-SKILL-320, FR-SKILL-330, FR-SKILL-340, FR-SKILL-350, FR-SKILL-360, IF-SKILL-010, INV-SKILL-010, INV-SPEC-070, INV-SPEC-080, NFR-SKILL-010, NFR-SKILL-020]
depends_on: []
```
...
```yaml
status: built
carries: [specs/README.md, specs/adr/template.md, skeleton]
requirements: [CON-SPEC-020, FR-ARCH-140, FR-GND-300, FR-INIT-220, FR-SKILL-020, FR-SKILL-200, FR-SKILL-220, FR-SKILL-240, FR-SKILL-350, FR-SPEC-030, IF-SPEC-010, IF-SPEC-030, INV-SPEC-010, INV-SPEC-020, INV-SPEC-030, INV-SPEC-040, INV-SPEC-050, INV-SPEC-060, INV-SPEC-070, NFR-SPEC-020]
depends_on: []
```
...
requirements: [FR-ARCH-170, FR-CI-010, FR-CI-020, FR-CI-030, FR-CI-040, FR-CI-050, FR-CI-060, FR-CI-080, FR-CI-090, FR-CI-100, FR-CI-110, FR-CI-120, FR-CI-130, FR-GND-310, FR-GND-370]
