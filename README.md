...
| `tools/` | `srs_check.py`, `srs_parse.py`, `srs_view.py`, `srs_upgrade.py`, `srs_baseline.py` (yours after install); `srs_grounds.py` (yours if you keep a register); `srs_init.py`, `srs_release.py` (stay here) |
