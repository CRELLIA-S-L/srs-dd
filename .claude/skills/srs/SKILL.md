...
5. The last two steps, always: close the loop; run the checker. A step that builds or tests is marked "requires the user's explicit confirmation each time" (ART-030).
